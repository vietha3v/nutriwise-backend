...
Hệ thống backend cho ứng dụng dinh dưỡng và sức khỏe NutriWise, được xây dựng với NestJS và TypeScript.

## 🚀 Tính năng chính

- **🔐 Xác thực & Phân quyền**: JWT, OAuth, Role-based access control
...
👉 **[Xem tài liệu đầy đủ tại đây](./docs/README.md)**

Tài liệu được chia nhỏ theo từng module để dễ dàng tham khảo và phát triển.

## 🛠️ Cài đặt

👉 **[Xem hướng dẫn cài đặt chi tiết](./docs/installation.md)**
